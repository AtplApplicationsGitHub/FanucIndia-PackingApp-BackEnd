...
//   async uploadOrderDetails(orderId: number, userId: number, userRole: string, data: UpdateMaterialDataDto) {
//     const order = await this.findOrderById(orderId, userId, userRole);
//     if (!order) {
//       throw new NotFoundException('Sales order not found or access denied.');
//     }
    
//     return this.processUpload(order.saleOrderNumber, data);
//   }

//   async uploadOrderDetailsBySoNumber(saleOrderNumber: string, userId: number, userRole: string, data: UpdateMaterialDataDto) {
...
//     return this.processUpload(saleOrderNumber, data);
//   }

//   private async processUpload(saleOrderNumber: string, data: UpdateMaterialDataDto) {
...
//       throw new BadRequestException('Failed to update material data.');
//     }
//   }
// }

// backend/src/modules/user-dashboard/user-dashboard.service.ts
